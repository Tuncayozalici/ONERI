...
public interface IDashboardQueryService
{
    ...
    Task<DashboardPageResult<ProfilLazerDashboardViewModel>> GetProfilLazerAsync(DateTime? raporTarihi, DateTime? baslangicTarihi, DateTime? bitisTarihi, int? ay, int? yil, CancellationToken cancellationToken = default);
